...
My work is to create that clarity.

I map how demand actually moves. I identify where measurement is trusted, broken, duplicated, or missing. I separate channel problems from funnel problems. I clarify decision rights. I make agencies accountable through standards and cadence rather than noise. I turn reporting into decision support. Then I encode what works into playbooks, workflows, QA routines, and operating rhythms that other people can use.
...
When the growth system gets messy, I make it legible. Then I make it repeatable.
