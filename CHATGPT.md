...
Sound like a senior operator who has seen the system from the inside.

Use plain language. Prefer concrete nouns and verbs. Do not over-polish. Do not turn every idea into a slogan.

## Communication QA

For workplace or executive artifacts, always check:

- Is the point clear in the first few lines?
- Does this create unnecessary defensiveness?
...
This repo should advertise judgment, not spill raw context. Public-facing content should stay true while stripping unnecessary internal detail.
